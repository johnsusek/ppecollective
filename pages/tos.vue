<template>
  <div>
    <h2>Welcome to Chicago PPE Collective</h2>
    <p>These terms and conditions outline the rules and regulations for the use of Chicago PPE Collective's Website.</p> <br>
    <span style="text-transform: capitalize;"> Chicago PPE Collective</span> is located at:<br>
    <address>
      <br>
    </address>
    <p>
      By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Chicago PPE Collective's website
    ...
    <p>
      We employ the use of cookies. By using Chicago PPE Collective's website you consent to the use of cookies
      in accordance with Chicago PPE Collective's privacy policy.
    </p><p>
    ...
    <p>
      Unless otherwise stated, Chicago PPE Collective and/or it's licensors own the intellectual property rights for
      all material on Chicago PPE Collective. All intellectual property rights are reserved. You may view and/or print
      pages from https://chicagoppecollective.org for your own personal use subject to restrictions set in these terms and conditions.
    </p>
    <p>You must not:</p>
    <ol>
      <li>Republish material from https://chicagoppecollective.org</li>
      <li>Sell, rent or sub-license material from https://chicagoppecollective.org</li>
      <li>Reproduce, duplicate or copy material from https://chicagoppecollective.org</li>
    </ol>
    <p>Redistribute content from Chicago PPE Collective (unless content is specifically made for redistribution).</p>
    ...
    <p>
      ...
      the visibility associated with the hyperlink outweighs the absence of Chicago PPE Collective; and (d) where the
    ...
    <p>
      ...
      you must notify us by sending an e-mail to <a href="mailto:john@johnsolo.net" title="send an email to john@johnsolo.net">john@johnsolo.net</a>.
    ...
    <p>
      No use of Chicago PPE Collective's logo or other artwork will be allowed for linking absent a trademark license
      agreement.
    </p>
    <h2>Iframes</h2>
    <p>
